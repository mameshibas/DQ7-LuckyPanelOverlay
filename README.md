# DQ7R Lucky Panel Overlay — 画面認識 + 透過オーバーレイ

DQ7R（Steam）のミニゲーム「ラッキーパネル」盤面を **画面キャプチャして解析**し、推定したタイル画像を **Qt6 の透過オーバーレイ**で盤面上に重ねて表示するツールです。  
...
## デモ
> [!WARNING]
> DEMOは無理やり撮影した影響で、オーバーレイの一部にちらつきが発生しています。

 https://github.com/user-attachments/assets/f99adfdb-9fb0-444a-a516-ae5067c4a2a4
